...
const OutputCallendar = () => (
  <div className="grid grid-cols-[1240px_min-content_1fr] grid-rows-[repeat(2,min-content)] items-center gap-x-[60px] gap-y-[20px] bg-gradient-to-t from-black via-[#000000_10%] to-transparent px-[100px] py-[85px] text-white">
