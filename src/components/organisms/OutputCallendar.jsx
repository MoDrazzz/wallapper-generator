...
const OutputCallendar = () => (
  <div className="grid grid-cols-[65vw_min-content_1fr] grid-rows-[repeat(2,min-content)] items-center gap-x-[60px] gap-y-[30px] bg-gradient-to-t from-black via-[#000000_5%] to-transparent px-[100px] py-[85px] text-white">
